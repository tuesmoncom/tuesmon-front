...
angular.module("tuesmonProfile").directive("tgProfileLiked", ProfileLikedDirective)
...
angular.module("tuesmonProfile").directive("tgProfileVoted", ProfileVotedDirective)
...
angular.module("tuesmonProfile").directive("tgProfileWatched", ProfileWatchedDirective)
