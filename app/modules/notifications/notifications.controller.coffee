...
class NotificationsController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$rootScope",
        "$scope",
...
angular.module("tuesmonNotifications").controller("Notifications", NotificationsController)
