...
NavigationBarDirective = (currentUserService, navigationBarService, locationService, navUrlsService, config) ->
    link = (scope, el, attrs, ctrl) ->
        ...
        tuesmon.defineImmutableProperty(scope.vm, "isAuthenticated", () -> currentUserService.isAuthenticated())
        tuesmon.defineImmutableProperty(scope.vm, "isEnabledHeader", () -> navigationBarService.isEnabledHeader())
...
angular.module("tuesmonNavigationBar").directive("tgNavigationBar", NavigationBarDirective)
