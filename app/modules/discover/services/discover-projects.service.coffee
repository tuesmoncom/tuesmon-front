...
class DiscoverProjectsService extends tuesmon.Service
    @.$inject = [
        "tgResources",
        "tgProjectsService"
    ]
    ...
    constructor: (@rs, @projectsService) ->
        ...
        tuesmon.defineImmutableProperty @, "mostLiked", () => return @._mostLiked
        tuesmon.defineImmutableProperty @, "mostActive", () => return @._mostActive
        tuesmon.defineImmutableProperty @, "featured", () => return @._featured
        tuesmon.defineImmutableProperty @, "searchResult", () => return @._searchResult
        tuesmon.defineImmutableProperty @, "nextSearchPage", () => return @._nextSearchPage
        tuesmon.defineImmutableProperty @, "projectsCount", () => return @._projectsCount
...
angular.module("tuesmonDiscover").service("tgDiscoverProjectsService", DiscoverProjectsService)
