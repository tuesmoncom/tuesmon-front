...
class DiscoverSearchController
    ...
    constructor: (@routeParams, @discoverProjectsService, @route, @location, @analytics, @appMetaService, @translate) ->
        ...
        tuesmon.defineImmutableProperty @, "searchResult", () => return @discoverProjectsService.searchResult
        tuesmon.defineImmutableProperty @, "nextSearchPage", () => return @discoverProjectsService.nextSearchPage
...
angular.module("tuesmonDiscover").controller("DiscoverSearch", DiscoverSearchController)
