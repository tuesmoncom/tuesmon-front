...
class MostLikedController
    ...
    constructor: (@discoverProjectsService) ->
        tuesmon.defineImmutableProperty @, "highlighted", () => return @discoverProjectsService.mostLiked
...
angular.module("tuesmonDiscover").controller("MostLiked", MostLikedController)
