...
class FeaturedProjectsController
    ...
    constructor: (@discoverProjectsService) ->
        tuesmon.defineImmutableProperty @, "featured", () => return @discoverProjectsService.featured

        @discoverProjectsService.fetchFeatured()

angular.module("tuesmonDiscover").controller("FeaturedProjects", FeaturedProjectsController)
