...
class MostActiveController
    ...
    constructor: (@discoverProjectsService) ->
        tuesmon.defineImmutableProperty @, "highlighted", () => return @discoverProjectsService.mostActive
...
angular.module("tuesmonDiscover").controller("MostActive", MostActiveController)
