...
class GithubImportController
    ...
    constructor: (@githubImportService, @confirm, @translate, @importProjectService) ->
        ...
        tuesmon.defineImmutableProperty @, 'projects', () => return @githubImportService.projects
        tuesmon.defineImmutableProperty @, 'members', () => return @githubImportService.projectUsers
...
angular.module('tuesmonProjects').controller('GithubImportCtrl', GithubImportController)
