...
class TrelloImportController
    ...
    constructor: (@trelloImportService, @confirm, @translate, @importProjectService) ->
        @.project = null
        tuesmon.defineImmutableProperty @, 'projects', () => return @trelloImportService.projects
        tuesmon.defineImmutableProperty @, 'members', () => return @trelloImportService.projectUsers
...
angular.module('tuesmonProjects').controller('TrelloImportCtrl', TrelloImportController)
