...
class JiraImportController
    ...
    constructor: (@jiraImportService, @confirm, @translate, @importProjectService) ->
        ...
        @.project = null
        tuesmon.defineImmutableProperty @, 'projects', () => return @jiraImportService.projects
        tuesmon.defineImmutableProperty @, 'members', () => return @jiraImportService.projectUsers
...
angular.module('tuesmonProjects').controller('JiraImportCtrl', JiraImportController)
