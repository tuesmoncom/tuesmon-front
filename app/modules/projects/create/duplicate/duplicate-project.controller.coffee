...
class DuplicateProjectController
    ...
    constructor: (@currentUserService, @projectsService, @location, @navUrls) ->
        ...
        tuesmon.defineImmutableProperty @, 'projects', () => @currentUserService.projects.get("all")
...
angular.module("tuesmonProjects").controller("DuplicateProjectCtrl", DuplicateProjectController)
