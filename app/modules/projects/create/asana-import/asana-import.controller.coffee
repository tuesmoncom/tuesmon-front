...
class AsanaImportController
    ...
    constructor: (@asanaImportService, @confirm, @translate, @importProjectService) ->
        ...
        @.project = null
        tuesmon.defineImmutableProperty @, 'projects', () => return @asanaImportService.projects
        tuesmon.defineImmutableProperty @, 'members', () => return @asanaImportService.projectUsers
...
angular.module('tuesmonProjects').controller('AsanaImportCtrl', AsanaImportController)
