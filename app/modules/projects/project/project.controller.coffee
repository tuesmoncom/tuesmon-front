...
class ProjectController
    ...
    constructor: (@routeParams, @appMetaService, @auth, @translate, @projectService) ->
        ...
        tuesmon.defineImmutableProperty @, "project", () => return @projectService.project
        tuesmon.defineImmutableProperty @, "members", () => return @projectService.activeMembers
...
angular.module("tuesmonProjects").controller("Project", ProjectController)
