...
class ExternalAppController extends tuesmon.Controller
    @.$inject = [
        "$routeParams",
    ...
    @navUrls, @xhrError, @loader) ->
        ...
        tuesmon.defineImmutableProperty @, "user", () => @._user
        tuesmon.defineImmutableProperty @, "application", () => @._application
...
angular.module("tuesmonExternalApps").controller("ExternalApp", ExternalAppController)
