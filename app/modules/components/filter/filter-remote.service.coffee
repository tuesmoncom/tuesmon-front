...
class FilterRemoteStorageService extends tuesmon.Service
    @.$inject = [
        "$q",
        "$tgUrls",
        "$tgHttp"
...
angular.module("tuesmonComponents").service("tgFilterRemoteStorageService", FilterRemoteStorageService)
