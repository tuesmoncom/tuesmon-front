...
class ProjectMenuController
    ...
    _videoConferenceUrl: () ->
        ...
        if @.project.get("videoconferences_extra_data")
            url = @.project.get("slug") + "-" + tuesmon.slugify(@.project.get("videoconferences_extra_data"))
        else
...
angular.module("tuesmonComponents").controller("ProjectMenu", ProjectMenuController)
