...
class AttachmentsFullService extends tuesmon.Service
    @.$inject = [
    ...
    constructor: (@attachmentsService, @rootScope) ->
        ...
        tuesmon.defineImmutableProperty @, 'attachments', () => return @._attachments
        tuesmon.defineImmutableProperty @, 'deprecatedsCount', () => return @._deprecatedsCount
        tuesmon.defineImmutableProperty @, 'attachmentsVisible', () => return @._attachmentsVisible
        tuesmon.defineImmutableProperty @, 'deprecatedsVisible', () => return @._deprecatedsVisible
    ...
    updateAttachment: (toUpdateAttachment, type) ->
        ...
        patch = tuesmon.patch(oldAttachment.get('file'), toUpdateAttachment.get('file'))
...
angular.module("tuesmonComponents").service("tgAttachmentsFullService", AttachmentsFullService)
