...
class AttachmentsFullController
    ...
    constructor: (@translate, @confirm, @config, @storage, @attachmentsFullService, @projectService, @attachmentsPreviewService) ->
        ...
        tuesmon.defineImmutableProperty @, 'attachments', () => return @attachmentsFullService.attachments
        tuesmon.defineImmutableProperty @, 'deprecatedsCount', () => return @attachmentsFullService.deprecatedsCount
        tuesmon.defineImmutableProperty @, 'attachmentsVisible', () => return @attachmentsFullService.attachmentsVisible
        tuesmon.defineImmutableProperty @, 'deprecatedsVisible', () => return @attachmentsFullService.deprecatedsVisible
...
angular.module("tuesmonComponents").controller("AttachmentsFull", AttachmentsFullController)
