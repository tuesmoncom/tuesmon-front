...
angular.module("tuesmonCommon").provider("$exceptionHandler", angular.mock.$ExceptionHandlerProvider)
...
describe "AppMetaService", ->
    ...
    it "set meta for twitter", () ->
        ...
        expect($("meta[name='twitter:site']")).to.have.attr("content",  "@tuesmoncom")
    ...
    it "set meta for open graph", () ->
        ...
        expect($("meta[property='og:site_name']")).to.have.attr("content", "Tuesmon - Love your projects")
