...
class ProjectService
    ...
    constructor: (@rootScope,  @projectsService, @xhrError, @userActivityService, @interval) ->
        ...
        tuesmon.defineImmutableProperty @, "project", () => return @._project
        tuesmon.defineImmutableProperty @, "section", () => return @._section
        tuesmon.defineImmutableProperty @, "sectionsBreadcrumb", () => return @._sectionsBreadcrumb
        tuesmon.defineImmutableProperty @, "activeMembers", () => return @._activeMembers
...
angular.module("tuesmonCommon").service("tgProjectService", ProjectService)
