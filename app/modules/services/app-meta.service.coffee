...
class AppMetaService
    ...
    setOpenGraphMetas: (title, description) ->
        @._set("og:type", "object")
        @._set("og:site_name", "Tuesmon - Love your projects")
        @._set("og:title", title)
...
angular.module("tuesmonCommon").service("tgAppMetaService", AppMetaService)
