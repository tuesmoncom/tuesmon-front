...
class CurrentUserService
    ...
    constructor: (@projectsService, @storageService, @rs) ->
        ...
        tuesmon.defineImmutableProperty @, "projects", () => return @._projects
        tuesmon.defineImmutableProperty @, "projectsById", () => return @._projectsById
...
angular.module("tuesmonCommon").service("tgCurrentUserService", CurrentUserService)
