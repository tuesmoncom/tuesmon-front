...
tuesmon = @.tuesmon
tuesmon.addClass = addClass
tuesmon.nl2br = nl2br
tuesmon.bindMethods = bindMethods
tuesmon.bindOnce = bindOnce
tuesmon.mixOf = mixOf
tuesmon.trim = trim
tuesmon.slugify = slugify
tuesmon.unslugify = unslugify
tuesmon.toggleText = toggleText
tuesmon.groupBy = groupBy
tuesmon.timeout = timeout
tuesmon.cancelTimeout = cancelTimeout
tuesmon.scopeDefer = scopeDefer
tuesmon.toString = toString
tuesmon.joinStr = joinStr
tuesmon.truncate = truncate
tuesmon.debounce = debounce
tuesmon.debounceLeading = debounceLeading
tuesmon.startswith = startswith
tuesmon.sizeFormat = sizeFormat
tuesmon.stripTags = stripTags
tuesmon.replaceTags = replaceTags
tuesmon.defineImmutableProperty = defineImmutableProperty
tuesmon.isImage = isImage
tuesmon.isEmail = isEmail
tuesmon.isPdf = isPdf
tuesmon.patch = patch
tuesmon.getRandomDefaultColor = getRandomDefaultColor
tuesmon.getDefaulColorList = getDefaulColorList
tuesmon.getMatches = getMatches
tuesmon.randomInt = randomInt
tuesmon.normalizeString = normalizeString
