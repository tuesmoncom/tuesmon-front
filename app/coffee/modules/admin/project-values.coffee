...
getDefaulColorList = @.tuesmon.getDefaulColorList
...
class ProjectValuesSectionController extends mixOf(tuesmon.Controller, tuesmon.PageMixin)
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgRepo",
...
class ProjectValuesController extends tuesmon.Controller
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgRepo",
...
# Custom attributes types (see tuesmon-back/tuesmon/projects/custom_attributes/choices.py)
TEXT_TYPE = "text"
...
class ProjectCustomAttributesController extends mixOf(tuesmon.Controller, tuesmon.PageMixin)
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgRepo",
...
class ProjectTagsController extends tuesmon.Controller
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgRepo",
