...
mixOf = @.tuesmon.mixOf
bindMethods = @.tuesmon.bindMethods
debounce = @.tuesmon.debounce
timeout = @.tuesmon.timeout

module = angular.module("tuesmonAdmin")
...
class WebhooksController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$scope",
        "$tgRepo",
        "$tgResources",
...
class GithubController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$scope",
        "$tgRepo",
        "$tgResources",
...
class GitlabController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$scope",
        "$tgRepo",
        "$tgResources",
...
class BitbucketController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$scope",
        "$tgRepo",
        "$tgResources",
...
class GogsController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$scope",
        "$tgRepo",
        "$tgResources",
