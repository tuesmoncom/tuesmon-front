...
module = angular.module("tuesmonBacklog")

#############################################################################
## Backlog Controller
#############################################################################

class BacklogController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin, tuesmon.UsFiltersMixin)
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgRepo",
