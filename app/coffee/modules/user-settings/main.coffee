...
module = angular.module("tuesmonUserSettings")
...
class UserSettingsController extends mixOf(tuesmon.Controller, tuesmon.PageMixin)
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgConfig",
...
TuesmonAvatarModelDirective = ($parse) ->
    link = ($scope, $el, $attrs) ->
...
module.directive('tgAvatarModel', ['$parse', TuesmonAvatarModelDirective])
