...
module = angular.module("tuesmonCommon")
...
trim = @.tuesmon.trim
normalizeString = @.tuesmon.normalizeString
...
class LightboxService extends tuesmon.Service
...
class LightboxKeyboardNavigationService extends tuesmon.Service
    stop: ->
        docEl = angular.element(document)
