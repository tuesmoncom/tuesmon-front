...
module = angular.module("tuesmonTaskboard")
...
class TaskboardController extends mixOf(tuesmon.Controller, tuesmon.PageMixin, tuesmon.FiltersMixin)
    @.$inject = [
        "$scope",
        "$rootScope",
        "$tgRepo",
    ...
    constructor: (@scope, @rootscope, @repo, @confirm, @rs, @rs2, @params, @q, @appMetaService, @location, @navUrls,
        ...
        tuesmon.defineImmutableProperty @.scope, "usTasks", () =>
            return @taskboardTasksService.usTasks

        tuesmon.defineImmutableProperty @.scope, "milestoneIssues", () =>
